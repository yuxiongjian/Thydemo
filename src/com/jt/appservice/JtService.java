...
public class JtService extends _JtService {
	...
	public static MyReturn mytest()
			throws InterruptedException, JSONRPCException {
		MyReturn ret = null;
		if (DebugSetting.isLocalDebug())
			return null;
//_CallJtService(MyHandler outerHandler, Class<?> retclass, String jsonCaller,	String fun, Object... param)
		ret = (MyReturn) JtService._CallJtService(null,MyReturn.class
				,Config.ServiceUrl.replace(Config.mobileType, "MyTest"),
				"testParam","A string",Calendar.getInstance().getTime(),5,null);
		return ret;
	...
	static public User Login(String un, String pwd)
		...
		//	throw new JSONRPCException("认证失败");
